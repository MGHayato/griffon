...
export const CARDS = [
  ...
  { id:"idolsong", name:"アイドルソング", cost:2, type:"spell", emoji:"🎤", text:"味方ユニット全体のHPを2回復",
    effect:{ kind:"heal", value:2, target:"allyAll" } },
  ...
  { id:"herb", name:"薬草", cost:2, type:"item", emoji:"🌿", text:"味方1体を2回復",
  ...
  { id:"dagger", name:"短剣", cost:2, type:"item", emoji:"🔪", text:"味方ユニット1体の攻撃力+1",
    effect:{ kind:"buffAtk", value:1, target:"allyUnit" } },
  { id:"woodshield", name:"木の盾", cost:2, type:"item", emoji:"🪵", text:"3ターンの間、味方1体が受けるダメージ-1",
    effect:{ kind:"shield", value:1, target:"allyUnit", turns:3 } },
  ...
  { id:"snowslime", name:"スノウスライム", cost:3, type:"unit", atk:1, hp:2, emoji:"⬜", text:"凍結している敵の数だけコスト-1",
    frostCost:1 },
  ...
  { id:"priestelf", name:"プリーストエルフ", cost:5, type:"unit", atk:2, hp:6, emoji:"🙏", text:"攻撃するたび味方1体を2回復",
    healOnAttack:2 },
...
export const DECKS = [
  { id:"alice", label:"アリス", emoji:"🗡️", desc:"どんな盤面でも活躍できるバランス型", total:40,
    cards:[["flare",2], ["heal",2], ["freeze",2], ["slash",2], ["thunder",2], ["storm",2], ["song",2], ["map",2], ["water",2], ["horn",2], ["slime",2], ["rabbit",2], ["goblin",2], ["wolf",2], ["ghost",2], ["vampbat",2], ["archer",2], ["healslime",2], ["golem",2], ["dragon",2]] },
  { id:"hansel", label:"ヘンゼル", emoji:"🍞", desc:"多彩な道具で味方を強化して戦う", total:40,
    cards:[["slash",2], ["salvage",2], ["water",2], ["glove",2], ["map",2], ["crumb",2], ["pebble",2], ["dagger",2], ["woodshield",2], ["sling",2], ["candybomb",2], ["slime",2], ["rabbit",2], ["goblin",2], ["thiefgoblin",2], ["ghost",2], ["vampbat",2], ["archer",2], ["rocketrabbit",2], ["dragon",2]] },
  { id:"gretel", label:"グレーテル", emoji:"🍬", desc:"回復手段が多い持久型", total:40,
    cards:[["heal",2], ["idolsong",2], ["shutup",2], ["highheal",2], ["veil",2], ["megaheal",2], ["lumiveil",2], ["water",2], ["map",2], ["crumb",2], ["herb",2], ["candybomb",2], ["slime",2], ["rabbit",2], ["goblin",2], ["thiefgoblin",2], ["healslime",2], ["rocketrabbit",2], ["archer",2], ["priestelf",2]] },
  { id:"snow", label:"スノウ", emoji:"🍎", desc:"氷系の呪文で敵を凍らせて戦う", total:40,
    cards:[["freeze",2], ["hail",2], ["frostbite",2], ["megafreeze",2], ["blizzard",2], ["megafrost",2], ["water",2], ["map",2], ["apple",2], ["poisonapple",2], ["slime",2], ["rabbit",2], ["wingoblin",2], ["ghost",2], ["vampbat",2], ["snowslime",2], ["yeti",2], ["yukionna",2], ["golem",2], ["windragon",2]] },
];
