...
export const CARDS = [
  ...
  { id:"dagger", name:"短剣", cost:2, type:"item", emoji:"🔪", text:"味方ユニット1体の攻撃力+2",
    effect:{ kind:"equip", value:2, target:"allyUnit", slot:"weapon" } },
  { id:"woodshield", name:"木の盾", cost:2, type:"item", emoji:"🪵", text:"味方ユニット1体が受けるダメージ-1",
    effect:{ kind:"equip", value:1, target:"allyUnit", slot:"armor" } },
